            ...
            <div className='row p-5 mt-5 text-center border-top'>
                <div className='col-8 p-4'>
                    ...
                    <ul style={{textAlign:"left", lineheight:"2.5", fontSize:"12px"}} className='text-muted fs-6'>
                        ...
                        Digital contract notes will be sent via e-mail.</li>
                        <br/>
                        ...
                        <li>If the account is in debit balance, any order placed will be charged ₹40 per executed order instead of ₹20 per executed order.</li><br/>
                    </ul>
                </div>
